...
as 
begin 
	INSERT INTO dbo.Consumidores(NombreCompleto, Telefono, CorreoElectronico, FechaRegistro, FrecuenciaCompra, PuntosFidelidad, Direccion)
...
begin 
	...
	create or alter procedure [Sp_Most_NombreConsumidor]
@NombreCompleto VARCHAR(250)
AS 
BEGIN
    SELECT * FROM dbo.Consumidores WHERE NombreCompleto LIKE '%' + @NombreCompleto + '%';
